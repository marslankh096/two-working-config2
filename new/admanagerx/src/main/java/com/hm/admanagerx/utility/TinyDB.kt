...
//        appContext.getSharedPreferences("app_db", Context.MODE_PRIVATE)
        PreferenceManager.getDefaultSharedPreferences(appContext)

    // Getters

    fun clearPreferences() {
        val preferenceFileName = "app_db"
        val preferenceFile =
            File(appContext.filesDir.parent + "/shared_prefs/" + preferenceFileName + ".xml")
    ...
    fun getFirstBoolean(key: String, defaultValue: Boolean = true): Boolean {
        return preferences.getBoolean(key, defaultValue)
    }
