...
//    }
    ...
    public static Drawable getPageNubmerDrawable() {
        if (pageNumberDrawable == null) {
            pageNumberDrawable = new ShapeDrawable(new RoundRectShape(new float[]{36, 36, 0, 0,
                    0, 0, 36, 36}, null, null));
            pageNumberDrawable.getPaint().setColor(0x80505050);
        }
        return pageNumberDrawable;
    }
    public static Drawable getPageNubmerDrawableV2() {
        if (pageNumberDrawable == null) {
            pageNumberDrawable =
            ...
            pageNumberDrawable.getPaint().setColor(Color.parseColor("#B3909cbb"));
        }
        return pageNumberDrawable;
    }
