...
public class TXTEncodingDialog extends ADialog {
    ...
    public void init(Context context) {
        ...
        TextView mainHeadingTitle = new TextView(context);
        mainHeadingTitle.setText("Select");
        dialogFrame.addView(mainHeadingTitle);
...
//        LayoutParams params = new LayoutParams(mWidth - GAP * 2, mHeight - spinner.getBottom() - ok.getHeight());
        LayoutParams params = new LayoutParams(mWidth - GAP * 2, ViewGroup.LayoutParams.WRAP_CONTENT);
