...
//            hidden = (Integer.parseInt(col.attributeValue("hidden")) != 0);
            if (
                col.attributeValue("hidden").contains("true")
                || col.attributeValue("hidden").contains("false")
            ) {
                hidden = Boolean.parseBoolean(col.attributeValue("hidden"));
            }
    ...
    private Row createRow(Element rowElement, int defaultRowHeight) {
        ...
        if (rowElement.attributeValue("hidden") != null) {
            ...
            if (
                rowElement.attributeValue("hidden").contains("true")
                || rowElement.attributeValue("hidden").contains("false")
            ) {
                hidden= Boolean.parseBoolean(rowElement.attributeValue("hidden"));
            }
        } else {
            hidden = false;
        }
