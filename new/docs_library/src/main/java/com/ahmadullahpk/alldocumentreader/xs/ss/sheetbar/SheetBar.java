...
public class SheetBar extends HorizontalScrollView implements OnClickListener {
    ...
    private void init() {
        ...
        this.sheetbarFrame.setBackgroundColor(-3355444); // Grey color -7829368 -- original
        ...
        FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, 100);
