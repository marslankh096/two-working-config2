...
//                reader.dispose();}
                ...
                control.getSysKit().getErrorKit().writerLog(exception, true);
                reader.dispose();
            } finally {
                reader = null;
            }
        ...
        public void onEnd(ElementPath elementPath) {
            ...
            if (name.equals("sheet")) {
                ...
                if (elem.attributeValue("date1904") != null) {
                    try{
                        String dateAttributeValue = "date1904";
                        usingDate1904= (Integer.parseInt(dateAttributeValue.replaceAll("[\\D]", ""))) > 0;
