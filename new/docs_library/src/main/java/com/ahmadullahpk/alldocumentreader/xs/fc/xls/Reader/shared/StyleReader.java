...
public class StyleReader {
    ...
    private void processCellStyleAlignment(CellStyle cellStyle, Element alignment) {
        ...
        if (alignment.attributeValue("wrapText") != null) {
            if (
               alignment.attributeValue("wrapText").contains("true")
               || alignment.attributeValue("wrapText").contains("false")
            ) {
                cellStyle.setWrapText(Boolean.parseBoolean(alignment.attributeValue("wrapText")));
            }
