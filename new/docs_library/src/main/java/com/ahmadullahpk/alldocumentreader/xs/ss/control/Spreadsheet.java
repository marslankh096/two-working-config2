...
public class Spreadsheet extends LinearLayout implements IFind, IReaderListener {
    /**
     * @param context
     */
    ...
    public void initCalloutView() {
        if (callouts == null) {
            callouts = new CalloutView(this.getContext(), control, null);
