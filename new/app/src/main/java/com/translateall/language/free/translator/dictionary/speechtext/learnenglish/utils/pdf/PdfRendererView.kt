...
import com.translateall.language.free.translator.dictionary.speechtext.learnenglish.utils.pdf.util.PdfEngine
import java.io.File
...
class PdfRendererView @JvmOverloads constructor(
    ...
    private var enableLoadingForPages: Boolean = true
    ...
    private val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        private fun updatePageNumberDisplay(position: Int) {
            if (position != NO_POSITION) {
                pageNo.text = "${position + 1} / $totalPageCount"
...
//                pageNo.text = context.getString(R.string.pdfView_page_no, position + 1, totalPageCount)
    ...
    fun getBitmapCurrentPage(): Bitmap? {
        return pdfRendererCore.getBitmapFromCache(currentPageIndex)
    }
