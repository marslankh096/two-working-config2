...
import static com.translateall.language.free.translator.dictionary.speechtext.learnenglish.utils.Constants.KEY_PHRASE_INPUT_LANG_CODE;
import static com.translateall.language.free.translator.dictionary.speechtext.learnenglish.utils.Constants.KEY_PHRASE_INPUT_LANG_NAME;
import static com.translateall.language.free.translator.dictionary.speechtext.learnenglish.utils.Constants.KEY_PHRASE_TRANSLATED_LANG_CODE;
import static com.translateall.language.free.translator.dictionary.speechtext.learnenglish.utils.Constants.KEY_PHRASE_TRANSLATED_LANG_NAME;
import static com.translateall.language.free.translator.dictionary.speechtext.learnenglish.utils.Constants.LANGUAGE_PREF;
...
public class TinyDB {
    ...
    public int getSpinnerInt(String key) {
        return preferences.getInt(key, -1);
    }
    ...
    public String getPhraseInputLangName(){
        return getString(KEY_PHRASE_INPUT_LANG_NAME);
    }

    public String getPhraseInputLangCode(){
        return getString(KEY_PHRASE_INPUT_LANG_CODE);
    }

    public String getPhraseTranslatedLangName(){
        return getString(KEY_PHRASE_TRANSLATED_LANG_NAME);
    }

    public String getPhraseTranslatedLangCode(){
        return getString(KEY_PHRASE_TRANSLATED_LANG_CODE);
    }

    public void putPhraseInputLangName(String value){
        putString(KEY_PHRASE_INPUT_LANG_NAME, value);
    }

    public void putPhraseInputLangCode(String value){
        putString(KEY_PHRASE_INPUT_LANG_CODE, value);
    }

    public void putPhraseTranslatedLangName(String value){
        putString(KEY_PHRASE_TRANSLATED_LANG_NAME, value);
    }

    public void putPhraseTranslatedLangCode(String value){
        putString(KEY_PHRASE_TRANSLATED_LANG_CODE, value);
    }
    ...
    public void putSoundBoolean(String key, boolean value) {
        checkForNullKey(key);
        preferences.edit().putBoolean(key, value).apply();
    }

    public String getLanguage() {
        return preferences.getString(LANGUAGE_PREF, "");
    }

    public void putLanguage(String value) {
        checkForNullKey(LANGUAGE_PREF);
        checkForNullValue(value);
        preferences.edit().putString(LANGUAGE_PREF, value).apply();
    }
    ...
    public void setOnboarding(Boolean value) {
        checkForNullKey(SHOW_ONBOARDING);
        preferences.edit().putBoolean(SHOW_ONBOARDING, value).apply();
    }
